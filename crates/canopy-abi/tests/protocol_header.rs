...
fn header_matches_the_rust_constants() {
    ...
    let expected: BTreeMap<&str, u64> = BTreeMap::from([
        ...
        (
            "CANOPY_PROP_MARGIN_TOP",
            u64::from(canopy_paint::MARGIN_TOP.raw()),
        ),
        (
            "CANOPY_PROP_MARGIN_RIGHT",
            u64::from(canopy_paint::MARGIN_RIGHT.raw()),
        ),
        (
            "CANOPY_PROP_MARGIN_BOTTOM",
            u64::from(canopy_paint::MARGIN_BOTTOM.raw()),
        ),
        (
            "CANOPY_PROP_MARGIN_LEFT",
            u64::from(canopy_paint::MARGIN_LEFT.raw()),
        ),
        (
            "CANOPY_PROP_PADDING_TOP",
            u64::from(canopy_paint::PADDING_TOP.raw()),
        ),
        (
            "CANOPY_PROP_PADDING_RIGHT",
            u64::from(canopy_paint::PADDING_RIGHT.raw()),
        ),
        (
            "CANOPY_PROP_PADDING_BOTTOM",
            u64::from(canopy_paint::PADDING_BOTTOM.raw()),
        ),
        (
            "CANOPY_PROP_PADDING_LEFT",
            u64::from(canopy_paint::PADDING_LEFT.raw()),
        ),
        // Display / visibility.
        (
            "CANOPY_PROP_DISPLAY",
            u64::from(canopy_paint::DISPLAY.raw()),
        ),
        (
            "CANOPY_PROP_VISIBILITY",
            u64::from(canopy_paint::VISIBILITY.raw()),
        ),
        // Position.
        (
            "CANOPY_PROP_POSITION",
            u64::from(canopy_paint::POSITION.raw()),
        ),
        (
            "CANOPY_PROP_INSET_TOP",
            u64::from(canopy_paint::INSET_TOP.raw()),
        ),
        (
            "CANOPY_PROP_INSET_RIGHT",
            u64::from(canopy_paint::INSET_RIGHT.raw()),
        ),
        (
            "CANOPY_PROP_INSET_BOTTOM",
            u64::from(canopy_paint::INSET_BOTTOM.raw()),
        ),
        (
            "CANOPY_PROP_INSET_LEFT",
            u64::from(canopy_paint::INSET_LEFT.raw()),
        ),
        (
            "CANOPY_PROP_Z_INDEX",
            u64::from(canopy_paint::Z_INDEX.raw()),
        ),
        // Flex.
        (
            "CANOPY_PROP_FLEX_WRAP",
            u64::from(canopy_paint::FLEX_WRAP.raw()),
        ),
        (
            "CANOPY_PROP_FLEX_BASIS",
            u64::from(canopy_paint::FLEX_BASIS.raw()),
        ),
        (
            "CANOPY_PROP_FLEX_SHRINK",
            u64::from(canopy_paint::FLEX_SHRINK.raw()),
        ),
        (
            "CANOPY_PROP_ALIGN_SELF",
            u64::from(canopy_paint::ALIGN_SELF.raw()),
        ),
        // Sizing.
        (
            "CANOPY_PROP_ASPECT_RATIO",
            u64::from(canopy_paint::ASPECT_RATIO.raw()),
        ),
        (
            "CANOPY_PROP_BOX_SIZING",
            u64::from(canopy_paint::BOX_SIZING.raw()),
        ),
        // Gaps — per-axis.
        (
            "CANOPY_PROP_ROW_GAP",
            u64::from(canopy_paint::ROW_GAP.raw()),
        ),
        (
            "CANOPY_PROP_COLUMN_GAP",
            u64::from(canopy_paint::COLUMN_GAP.raw()),
        ),
        // Overflow — reserved for a later wave.
        (
            "CANOPY_PROP_OVERFLOW",
            u64::from(canopy_paint::OVERFLOW.raw()),
        ),
        // Border longhands.
        (
            "CANOPY_PROP_BORDER_STYLE",
            u64::from(canopy_paint::BORDER_STYLE.raw()),
        ),
        (
            "CANOPY_PROP_BORDER_TOP_WIDTH",
            u64::from(canopy_paint::BORDER_TOP_WIDTH.raw()),
        ),
        (
            "CANOPY_PROP_BORDER_RIGHT_WIDTH",
            u64::from(canopy_paint::BORDER_RIGHT_WIDTH.raw()),
        ),
        (
            "CANOPY_PROP_BORDER_BOTTOM_WIDTH",
            u64::from(canopy_paint::BORDER_BOTTOM_WIDTH.raw()),
        ),
        (
            "CANOPY_PROP_BORDER_LEFT_WIDTH",
            u64::from(canopy_paint::BORDER_LEFT_WIDTH.raw()),
        ),
        (
            "CANOPY_PROP_BORDER_TOP_COLOR",
            u64::from(canopy_paint::BORDER_TOP_COLOR.raw()),
        ),
        (
            "CANOPY_PROP_BORDER_RIGHT_COLOR",
            u64::from(canopy_paint::BORDER_RIGHT_COLOR.raw()),
        ),
        (
            "CANOPY_PROP_BORDER_BOTTOM_COLOR",
            u64::from(canopy_paint::BORDER_BOTTOM_COLOR.raw()),
        ),
        (
            "CANOPY_PROP_BORDER_LEFT_COLOR",
            u64::from(canopy_paint::BORDER_LEFT_COLOR.raw()),
        ),
        (
            "CANOPY_PROP_BORDER_TOP_LEFT_RADIUS",
            u64::from(canopy_paint::BORDER_TOP_LEFT_RADIUS.raw()),
        ),
        (
            "CANOPY_PROP_BORDER_TOP_RIGHT_RADIUS",
            u64::from(canopy_paint::BORDER_TOP_RIGHT_RADIUS.raw()),
        ),
        (
            "CANOPY_PROP_BORDER_BOTTOM_RIGHT_RADIUS",
            u64::from(canopy_paint::BORDER_BOTTOM_RIGHT_RADIUS.raw()),
        ),
        (
            "CANOPY_PROP_BORDER_BOTTOM_LEFT_RADIUS",
            u64::from(canopy_paint::BORDER_BOTTOM_LEFT_RADIUS.raw()),
        ),
        // Text.
        (
            "CANOPY_PROP_FONT_SIZE",
            u64::from(canopy_paint::FONT_SIZE.raw()),
        ),
        (
            "CANOPY_PROP_FONT_WEIGHT",
            u64::from(canopy_paint::FONT_WEIGHT.raw()),
        ),
        (
            "CANOPY_PROP_LINE_HEIGHT",
            u64::from(canopy_paint::LINE_HEIGHT.raw()),
        ),
        (
            "CANOPY_PROP_TEXT_DECORATION",
            u64::from(canopy_paint::TEXT_DECORATION.raw()),
        ),
        // Outline.
        (
            "CANOPY_PROP_OUTLINE_WIDTH",
            u64::from(canopy_paint::OUTLINE_WIDTH.raw()),
        ),
        (
            "CANOPY_PROP_OUTLINE_COLOR",
            u64::from(canopy_paint::OUTLINE_COLOR.raw()),
        ),
        (
            "CANOPY_PROP_OUTLINE_OFFSET",
            u64::from(canopy_paint::OUTLINE_OFFSET.raw()),
        ),
        // Effects.
        (
            "CANOPY_PROP_BOX_SHADOW",
            u64::from(canopy_paint::BOX_SHADOW.raw()),
        ),
        (
