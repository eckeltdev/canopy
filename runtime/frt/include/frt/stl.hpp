...
// stl.hpp — the freestanding-safe std vocabulary, re-exported under frt.
//
...
// I/O: they are pure value/view/ownership vocabulary. Consumer code spells `frt::span`
...
namespace frt {
    ...
    // runtime routes through the frt platform seam (see new_delete.cpp); it is allowed here
