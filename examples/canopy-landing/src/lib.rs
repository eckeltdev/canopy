//! Canopy **landing** — a stunning one-page (no-scroll) welcome screen.
//!
//! Dark, minimal, and animated, in the spirit of a modern product landing (design
//! inspiration: x.ai). It exists to show off what Canopy can do now that the core has
//! opacity + translate + alpha compositing, flex alignment, and a real animation
//! timeline:
//!
...
//!   composite correctly over the black canvas because the renderer now alpha-blends.
