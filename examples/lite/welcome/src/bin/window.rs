...
//! restart. The UI is built by [`canopy_lite_welcome::build`]; this file is only platform
...
//!
//! Run from `examples/lite/welcome`: `cargo run`.
...
use canopy_lite_welcome::{build, load_styles, Welcome, STYLES_PATH, VIEW_H, VIEW_W};
